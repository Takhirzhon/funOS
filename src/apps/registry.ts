...
export const apps = {
  ...
  /* Start > Control Panel, or `control` in Run. Classic view. */
  controlPanel: {
    title: "Control Panel",
    label: "Control Panel",
    component: app(() => import("./ControlPanel"), "ControlPanel"),
  ...
  addRemovePrograms: {
    ...
    component: app(() => import("./AddRemovePrograms"), "AddRemovePrograms"),
  ...
  folderOptions: {
    ...
    component: app(() => import("./FolderOptions"), "FolderOptions"),
  ...
  search: {
    ...
    label: "Search",
    component: app(() => import("./Search"), "Search"),
    icon: SearchIcon,
  ...
  helpAndSupport: {
    ...
    component: app(() => import("./HelpAndSupport"), "HelpAndSupport"),
    icon: HelpIcon,
  ...
  dateTime: {
    ...
    label: "Date and Time",
    component: app(() => import("./DateTime"), "DateTime"),
    icon: DateTimeIcon,
  ...
  sounds: {
    ...
    component: app(() => import("./Sounds"), "Sounds"),
    icon: AudioDevicesIcon,
  ...
  taskbarProperties: {
    ...
    component: app(() => import("./TaskbarProperties"), "TaskbarProperties"),
    icon: TaskbarStartMenuIcon,
