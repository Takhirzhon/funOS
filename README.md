...
- Apps:
  ...
  - **Paint**, **Command Prompt**, **Calculator**, **Minesweeper** (the window is the size of the board), **Solitaire** (the cards.dll bitmaps, all twelve backs under Game > Deck; Draw one/three, Standard and Vegas scoring, the timer; drag the cards, double-click sends one home)
