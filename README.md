...
- Apps:
  ...
  - **Paint**, **Command Prompt**, **Calculator**, **Minesweeper** (the window is the size of the board), **Solitaire** (the cards.dll bitmaps, all twelve backs under Game > Deck; drag the cards, or click; double-click sends one home)
